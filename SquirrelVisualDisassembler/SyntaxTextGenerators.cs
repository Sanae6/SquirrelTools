...
namespace SquirrelVisualDisassembler {
    public class JumpGenerator : VisualLineElementGenerator {
    ...
    public class JumpVisualLineText : VisualLineText {
        internal int line;
        public JumpVisualLineText(VisualLine parentVisualLine, int length) : base(parentVisualLine, length) { }
        
        public override TextRun CreateTextRun(int startVisualColumn, ITextRunConstructionContext context) {
            TextRunProperties.ForegroundBrush = Brushes.GreenYellow;
